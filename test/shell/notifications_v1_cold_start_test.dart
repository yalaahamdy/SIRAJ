...
void main() {
  group('SIRAJ v1.0 — Sprint 15: Cold Start from Notification Launch Suite (§45, §106)', () {
    ...
    testWidgets('Cold Start 1: App initializes gracefully from notification entry without crash', (tester) async {
